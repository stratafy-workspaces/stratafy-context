...
## Description
The workspace's institutional memory. Documents with full versioning, content editing, and tree-based organisation structure. Documents can be linked to any entity, creating a knowledge graph that enriches AI context across the platform. Future capability: native document signing with cryptographic hashing, eliminating the need for PDF conversion or external e-signature tools for standard commercial contracts.
