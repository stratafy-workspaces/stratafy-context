...
lastUpdated: 2026-02-25T06:12:33.014+00:00
...
## Description
Sequoia Engagement strategy must account for two critical developments:

1. **Sequoia invested in Anthropic** (Jan 2026) — $25B round at $350B valuation. Stratafy is now an ecosystem play for a platform Sequoia has bet billions on. Pitch framing shifts from "bet on a new category" to "capture more value from a bet you've already made."

2. **Roelof Botha no longer leads Sequoia** — pushed out in late 2025, replaced by Alfred Lin and Pat Grady. The Pieter de Villiers → Roelof pathway still has value (relationships, influence) but decision-makers have changed. Need to assess whether Pieter connects to new leadership or if parallel pathway is needed.

**Updated pitch narrative:** "You invested billions in Anthropic's ecosystem. We're building the strategic intelligence layer for that ecosystem — 115 MCP tools, the first strategy plugin for Cowork, deeper platform integration than anyone. We're not asking you to bet on a new category; we're asking you to capture more value from a bet you've already made."

**Key angles:**
- Ecosystem infrastructure play (picks and shovels for Anthropic platform)
- Cowork plugin as proof of integration depth
- Anthropic IPO preparation makes ecosystem plays more valuable
- Cross-portfolio value: Stratafy could serve Sequoia's OpenAI and xAI portfolio companies too (model-agnostic strategic OS)

**Pathway options:**
- Primary: Pieter de Villiers → Roelof (still valuable for warm intro, but Roelof no longer final decision-maker)
- Explore: Direct pathway to Alfred Lin or Pat Grady via Anthropic ecosystem angle
- Explore: Anthropic itself as introduction vector (Stratafy as showcase ecosystem partner)
