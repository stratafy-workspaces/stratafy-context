...
## Description
One strategic system, many role-appropriate interfaces — the same context adapts for CEO (Strategic Advisor), board (Strategic Interface), managers (Strategic Coach), and ICs (Strategic Guide).
